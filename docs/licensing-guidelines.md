...
**Research data:** Use one of two Creative Commons licences: Use the [CC-BY-Attribution licence](https://creativecommons.org/licenses/by/4.0/) as a default choice. This licence allows users to distribute, remix, tweak, and build upon a work, even commercially, as long as they give credit to the original creator of the work. If you want any derivatives of data to be shared under identical terms, i.e. the licence is "infectious", use the [CC-SA Share-Alike licence](https://creativecommons.org/licenses/by-sa/4.0/).
**Databases:** Use one of two Open Data Commons licences: Use the [ODC-By licence](https://opendatacommons.org/licenses/by/1-0/) as a default choice. This licence allows users to freely share, modify, and use a database providing that they include a notice to the original database. If you want any derivative databases to be shared under identical terms, i.e. the licence is "infectious", use the [OCD-ODbL licence](https://opendatacommons.org/licenses/odbl/1.0/).
